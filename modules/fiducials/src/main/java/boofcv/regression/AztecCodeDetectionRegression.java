...
import boofcv.metrics.qrcode.DetectAztecCodeImages;
...
public class AztecCodeDetectionRegression extends BaseRegression implements ImageRegression {

    String pathDataset = "data/fiducials/aztec";

    // directory used as temporary workspace
    File fileTmp = new File("tmp");


    public AztecCodeDetectionRegression() {
    ...
    public void process(ImageDataType type) throws IOException {
        ...
        evaluator.out = new PrintStream(new File(directoryMetrics, "ACC_AztecCode.txt"));
        ...
        runtime.initializeLog(directoryRuntime, getClass(), "RUN_AztecCode.txt");
    ...
    private <T extends ImageGray<T>> void detect(ImageDataType type, File generatedBase, File detectedBase) {
        ...
        var detector = new DetectAztecCodeImages<>(imageType);
        try {
            detector.detector = FactoryFiducial.aztec(null, imageType);
    ...
    private boolean renderSyntheticImages(ImageDataType type, File generatedBase, File detectedBase) {
        ...
        try {
            ...
            if (!renderedOutput.exists() || FileUtils.isEmptyDirectory(renderedOutput)) {
                ...
                generator.inputFile = new File(generatedBase, "aztec.pdf").getPath();
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, IllegalAccessException, InstantiationException {
        ...
        RegressionRunner.main(new String[]{AztecCodeDetectionRegression.class.getName(), ImageDataType.F32.toString()});
        RegressionRunner.main(new String[]{AztecCodeDetectionRegression.class.getName(), ImageDataType.U8.toString()});
    }
}
